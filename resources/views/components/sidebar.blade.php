  ...
  <div class="sidebar-inner px-4 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item {{ (request()->is('user')) ? 'active' : '' }}">
        <a href="{{ route('user.data') }}" class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon">
      ...
      <li class="nav-item {{ (request()->is('rating')) ? 'active' : '' }}">
        <a href="{{ route('rating') }}" class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon">
      ...
      <li class="nav-item {{ (request()->is('history')) ? 'active' : '' }}">
        <a href="{{ route('history') }}" class="nav-link d-flex justify-content-between">
          <span>
            <span class="sidebar-icon">
              <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"></path></svg>
            </span>
            <span class="sidebar-text">Histori View</span>
          </span>
        </a>
      </li>
