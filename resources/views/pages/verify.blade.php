...
<!-- START SHOWCASE -->
		...
		<tr>
			<td align="center">
				<table class="col-600" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px; margin-right:20px; border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9; border-bottom: 1px solid #dbd9d9;">
                        <tbody><tr>
                            <td height="35"></td>
                        </tr>

                        <tr>
                            <td align="center" style="font-family: 'Raleway', sans-serif; font-size:22px; font-weight: bold; color:#333;">HI Zaenal Muttaqin</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            Silahkan verifikasi email kamu sekarang dengan menekan tombol di bawah ini.<br></td>
                        </tr>
                                ...
                                <table class="button" style="border: 2px solid #fff;" bgcolor="#1F2937" width="30%" border="0" cellpadding="0" cellspacing="0">
                                    <tbody><tr>
                                        ...
                                        <td height="30" align="center" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#ffffff;">
                                            <a href="#" style="color:#ffffff; text-decoration: none;">Verifikasi Email</a>
                                        </td>
                                        <td width="10"></td>
                                    </tr>
                                </tbody></table>
